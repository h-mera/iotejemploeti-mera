...
#define FLESPI_TOKEN    "lCG8yJPUWRc9awe3M2AaTuKcqd5N4Nvgd1cByPklwkiuGmogcOgW6QWmURXOujSx"
#define DEVICE_IDENTIFICATION_STRING "flespi"

#define WLAN_SSID       "MOVISTAR_4760"
#define WLAN_PASS       "jzC9zkpTfQs7qd62JE7L"
...
void loop() {
  ...
  int my_sensor_value = analogRead(A0);
  ...
  Serial.println(my_sensor_value);
  flespi.publish(my_sensor_value);
